...
- `story/runtime/chapter_memo.md` 或 `story/runtime/chapter-{NNNN}.intent.md` ——本章的 chapter_memo（goal / threadRefs / 该兑现的 / hook 账 / 不要做）。两种命名都可能存在（取决于 Planner 实现版本），优先读后者
